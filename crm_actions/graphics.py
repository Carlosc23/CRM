...
def graph6():
    ...
    trace = go.Bar(x=labels, y=values,text=['27% market share', '24% market share', '19% market share'], marker=dict(
        color=['rgba(222,45,38,0.8)', 'rgba(222,45,38,0.8)',
               ...
               'rgba(222,45,38,0.8)','rgba(204,204,204,1)','rgba(204,204,204,1)','rgba(204,204,204,1)','rgba(204,204,204,1)',
               'rgba(204,204,204,1)','rgba(204,204,204,1)','rgba(204,204,204,1)','rgba(204,204,204,1)','rgba(204,204,204,1)',
               'rgba(204,204,204,1)','rgba(204,204,204,1)','rgba(204,204,204,1)','rgb(58,200,225)','rgb(58,200,225)',
